...
Interactive application for visualizing whole-brain surface vertex-wise statistical maps is a fork of the **`verywise`wizard** app, hosted here https://github.com/SereDef/verywise-wizard.git.
